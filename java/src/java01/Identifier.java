...
/**
 * @author wzw
 * @create 2020-09-26 19:53
 * @email 2405181714@qq.comb
 */
public class Identifier {
	public static void main(String [] args){

		//标识符：Java就是遵从命名规则可以命名使用的字符序列
		//凡是自己可以起的名字的地方都叫标识符，比如变量 方法 类
		...
		包名：多单词组成，都是小写：xxxyyy
		类名：多单词组成，单词都是大写开头XxxYyy
		属性名/变量名、方法名：都是第一个单词小写，后面单词大写开头xxxYyyZzz
		常量名/局部变量：多单词组成 都是大写，多个单词用下划线分割CCC_VVV

		注意：在起名字的同时，为了提高阅读性和维护，要尽量有意义“见名知意“
		注意：java采用Unicode字符集，因此标识符也可以使用汉子声明，但不建议。
		*
		*
		*
		* 第2章 有意义的命名
